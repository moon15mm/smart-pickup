...
__decorate([
    (0, typeorm_1.ManyToOne)(() => store_entity_1.Store, (s) => s.products, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => product_category_entity_1.ProductCategory, (c) => c.products, { nullable: true }),
...
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Product.prototype, "posRefId", void 0);
__decorate([
